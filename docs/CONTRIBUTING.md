...
This document is inspired by similar instructions from MintPy, numpy, GMT, ISCE, gdal and jupyterhub. If you're reading this section, you're probably interested in contributing to ATBD. Welcome and thanks for your interest in contributing! 

These are several ways to contribute to the ATBD project:

* Writing or proofreading documentation (including tutorials and examples in jupyter-notebooks)
* Submitting bug reports or feature requests on [GitHub issue](https://github.com/nisar-solid/ATBD/issues)
...
If you get stuck at any point you can open an [issue on GitHub](https://github.com/nisar-solid/ATBD/issues) or comment on any open issue or pull request.
...
+ Go to https://github.com/nisar-solid/ATBD.git and click "fork" button to create your own copy of the project.

+ Clone the project to your local computer and add the upstream repository:

   ```
   git clone https://github.com/your_user_name/ATBD.git
   cd ATBD
   git remote add upstream https://github.com/nisar-solid/ATBD.git
   ```
...
+ **Open an [issue](https://github.com/nisar-solid/ATBD/issues) first** if you plan to introduce a new feature or to change funcationality, we may have easier ways to help you implement it. If there is already an issue that matches your idea, leave a comment there instead to let us know what you plan to do. For bug fixes, documentation updates, etc., this is generally not necessary.
...
(For anyone with push rights to github.com/nisar-solid/ATBD) Never modify a commit or the history of anything that has been committed to the `main` branch.
